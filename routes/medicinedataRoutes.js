...
const medicineController = require('../controllers/medicinedataController'); // Adjust the path to your controller
...
medicine.post('/importmedicinedata', upload.single('file'), (req, res) => {
